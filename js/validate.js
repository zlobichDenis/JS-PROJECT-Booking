...
const onTypeChange = () => {
        priceInput.placeholder = MinPrices[typeField.value]; // В плейсхолдер добавляем значние равное минимальному значению типа жилья из массива
        priceInput.min = MinPrices[typeField.value]; // Добавляем свойство min в дом
